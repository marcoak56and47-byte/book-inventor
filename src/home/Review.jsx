          ...
          >
            ...
            <SwiperSlide className='shadow-xl py-8 px-4 md:m-5 rounded-lg border bg-white'>
              <div className='space-y-6 relative'> 
                ...
                <div>
                  <p className='text-lg mt-12'>
                  Shopping here has been a delightful experience. The selection is top-notch, and the prices are very reasonable. I appreciate the fast and customer freindly shipping and the condition in which the books arrive. The customer service is also very 
                  </p>
                </div>
              </div>
            </SwiperSlide>
